    ...
    open class NormalNavigator(
        ...
        override fun navigate(
            ...
            try {
                ...
                var mBackStack: java.util.ArrayDeque<Int> = mBackStackField.get(this) as java.util.ArrayDeque<Int>
...
//                var mIsPendingBackStackOperation: Boolean =
//                    mIsPendingBackStackOperationField.get(this) as Boolean
