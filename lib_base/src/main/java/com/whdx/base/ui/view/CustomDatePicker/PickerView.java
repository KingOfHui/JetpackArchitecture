...
public class PickerView extends View implements WeakRefHandler.Callback {
    /**
    ...
    WeakRefHandler updateHandler = new WeakRefHandler(this);
    /**
    ...
    private void init() {
        ...
        mPaint.setColor(getResources().getColor(R.color.normal_text_color));
        //第二个paint
        nPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        nPaint.setStyle(Style.FILL);
        nPaint.setTextSize(22);
        nPaint.setTextAlign(Align.CENTER);
        nPaint.setColor(getResources().getColor(R.color.second_text_color));
    }
