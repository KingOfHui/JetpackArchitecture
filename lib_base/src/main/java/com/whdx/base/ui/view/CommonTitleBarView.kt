 ...
 */
class CommonTitleBarView @JvmOverloads constructor(
    ...
    init {
        val obtainStyledAttributes =
            context.obtainStyledAttributes(attrs, R.styleable.CommonTitleBarView)
        mLeftTextId =
            obtainStyledAttributes.getResourceId(R.styleable.CommonTitleBarView_left_textId, 0)
        mLeftTextStr =
            obtainStyledAttributes.getString(R.styleable.CommonTitleBarView_left_textStr)
        mRightTextId =
            obtainStyledAttributes.getResourceId(
                R.styleable.CommonTitleBarView_right_textId,
                0
            )
        mRightTextStr =
            obtainStyledAttributes.getString(R.styleable.CommonTitleBarView_right_textStr)
        mRightTextColor = obtainStyledAttributes.getColor(R.styleable.CommonTitleBarView_right_text_color, 0)

        mLeftImg =
            obtainStyledAttributes.getResourceId(R.styleable.CommonTitleBarView_left_img, 0)
        mShowLeftImg = obtainStyledAttributes.getBoolean(
            R.styleable.CommonTitleBarView_isShow_left_img,
            false
        )
        mRightImg1 =
            obtainStyledAttributes.getResourceId(R.styleable.CommonTitleBarView_right_img1, 0)
        mRightImg2 =
            obtainStyledAttributes.getResourceId(R.styleable.CommonTitleBarView_right_img2, 0)
        mRightImg3 =
            obtainStyledAttributes.getResourceId(R.styleable.CommonTitleBarView_right_img3, 0)
        mShowRightImg1 = obtainStyledAttributes.getBoolean(
            R.styleable.CommonTitleBarView_isShow_right_img1,
            false
        )
        mShowRightImg2 = obtainStyledAttributes.getBoolean(
            R.styleable.CommonTitleBarView_isShow_right_img2,
            false
        )
        mRightImg3 =
            obtainStyledAttributes.getResourceId(R.styleable.CommonTitleBarView_right_img3, 0)
        ...
        mTitleTextId = obtainStyledAttributes.getResourceId(
            R.styleable.CommonTitleBarView_title_textId,
            0
        )
        mTitleTextStr =
            obtainStyledAttributes.getString(R.styleable.CommonTitleBarView_title_textStr)
        mTextColor =
            obtainStyledAttributes.getColor(R.styleable.CommonTitleBarView_text_color, 0)
        mShowTabLayout = obtainStyledAttributes.getBoolean(
            R.styleable.CommonTitleBarView_isShow_tab_layout,
            false
        )
        mNavigationBar =
            obtainStyledAttributes.getColor(R.styleable.CommonTitleBarView_bg_color, 0)
        initView()
